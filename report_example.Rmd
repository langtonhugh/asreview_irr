...
```{r}
# Here, note that ASReview updated their default column names late-2021. Choose the relevant mutate() option for your data.
disagree2_df %>% 
  mutate(publication_year = str_remove_all(publication_year, "///")) %>% # For older projects.
  # mutate(publication_year = str_remove_all(year, "///")) %>% # For newer projects.
